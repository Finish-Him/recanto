...
function abrirWhatsApp(tipo) {
    const telefone = '<?php echo WHATSAPP_NUMBER; ?>'; // Número do WhatsApp
    let mensagem = '';
    
    switch(tipo) {
        case 'geral':
            mensagem = '<?php echo getWhatsAppMessage("geral"); ?>';
            break;
        case 'megapromocao':
            mensagem = '<?php echo getWhatsAppMessage("megapromocao"); ?>';
            break;
        case 'promocao':
            mensagem = '<?php echo getWhatsAppMessage("promocao"); ?>';
            break;
        case 'estacoes':
            mensagem = '<?php echo getWhatsAppMessage("estacoes"); ?>';
            break;
        case 'reserva':
            mensagem = '<?php echo getWhatsAppMessage("reserva"); ?>';
            break;
        case 'contato':
            mensagem = '<?php echo getWhatsAppMessage("contato"); ?>';
            break;
        case 'float':
            mensagem = '<?php echo getWhatsAppMessage("float"); ?>';
            break;
        default:
            mensagem = '<?php echo getWhatsAppMessage("geral"); ?>';
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            .catch(error => {
                formMessage.className = 'form-message error';
                formMessage.textContent = 'Erro ao enviar formulário. Tente novamente.';
                formMessage.style.display = 'block';
            })
            .finally(() => {
